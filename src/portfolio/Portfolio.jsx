                            ...
                            <div className="grid lg:grid-cols-2 gap-12">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative p-12 flex items-center justify-center">
                                        <img src="../React_portfolio/public/images/imteaj.png" alt="Profile"
                        ...
                        <div className="max-w-7xl mx-auto px-6">
                            ...
                            >
                                <motion.div variants={itemFadeIn} className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                                    <img src="../React_portfolio/public/images/ecommerce-store-trinidad.jpeg?height=192&width=384" alt="Project 1"
                                ...
                                <motion.div variants={itemFadeIn} className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                                    <img src="../React_portfolio/public/images/project/textcrm.png" alt="Project 2"
                                        className="w-full h-48 object-cover" />
                                    <div className="p-6">
                                ...
                                <motion.div variants={itemFadeIn} className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                                    <img src="../React_portfolio/public/images/project/Screenshot 2024-11-29 at 11.10.57 AM.png" alt="Project 3"
                                        className="w-full h-48 object-cover" />
                                    <div className="p-6">
                                ...
                                <motion.div variants={itemFadeIn} className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                                    <img src="../React_portfolio/public/images/project/Screenshot 2024-11-29 at 11.13.02 AM.png" alt="Project 4"
                                        className="w-full h-48 object-cover" />
                                    <div className="p-6">
