...
// Ultra Modern Code Block Component with Advanced Features
const UltraModernCodeBlock = ({ code, language, isDarkMode, onCopy, isCopied, showLineNumbers = true }) => {
  ...
  return (
    ...
    >
      {/* Code Header */}
      <div className="flex items-center justify-between bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 px-3 sm:px-6 py-3 rounded-t-xl sm:rounded-t-2xl border border-gray-700 dark:border-gray-600">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-shrink overflow-hidden">
          ...
          {/* Code Stats */}
          <div className="hidden md:flex items-center gap-1.5 px-2 py-1 bg-gray-700 text-gray-300 rounded-full text-xs">
        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0 ml-2">
          ...
          <motion.button
            ...
            className="hidden sm:flex items-center gap-1.5 px-2 py-1.5 text-xs bg-gray-700 hover:bg-gray-600 text-gray-300 rounded-lg transition-colors"
          >
            {isHidden ? <EyeOn className="w-3 h-3" /> : <EyeOff className="w-3 h-3" />}
          </motion.button>
          ...
          <motion.button
            ...
            className={`hidden sm:flex items-center gap-1.5 px-2 py-1.5 text-xs rounded-lg transition-colors ${
              showLineNumbers ? 'bg-blue-600 text-white' : 'bg-gray-700 hover:bg-gray-600 text-gray-300'
            }`}
          >
          ...
          <motion.button
            ...
            disabled={isRunning}
            className={`hidden sm:flex items-center gap-1.5 px-2 py-1.5 text-xs rounded-lg transition-colors ${
              isRunning ? 'bg-yellow-600 text-white' : 'bg-gray-700 hover:bg-gray-600 text-gray-300'
            }`}
          >
      ...
      <AnimatePresence>
        {executionResult && (
          <motion.div
            ...
            className="bg-gray-900 text-green-400 px-4 py-2 text-xs font-mono border-l-4 border-green-500"
          >
      ...
      {/* Code Content */}
      <div 
        className={`relative overflow-x-auto rounded-b-xl sm:rounded-b-2xl border-x border-b border-gray-700 dark:border-gray-600 ${
...
// Ultra Modern Blog Content Renderer with Advanced Features
const UltraModernBlogContent = ({ content, isDarkMode }) => {
  ...
  const toggleLineNumbers = (codeId) => {
  ...
  const processTextContent = (text) => {
    ...
    processed = processed.replace(
      /^(\d+)\.\s+(.+)$/gm,
      '<li class="mb-2 sm:mb-3 text-gray-700 dark:text-gray-300 flex items-start gap-2 sm:gap-3 break-words"><span class="mt-0.5 w-6 h-6 flex items-center justify-center text-xs font-bold bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-full flex-shrink-0">$1</span><span class="flex-1 min-w-0">$2</span></li>'
    );
    ...
    processed = processed.replace(
      /\[([^\]]+)\]\(([^)]+)\)/g,
      '<a href="$2" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 underline decoration-2 underline-offset-4 decoration-blue-400 hover:decoration-blue-600 transition-all duration-200 font-medium break-words relative group" target="_blank" rel="noopener noreferrer">$1 <svg class="inline w-3 h-3 ml-1 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg></a>'
    );
  ...
  return (
    <div className="ultra-modern-blog-content">
      {processedElements.map((element) => {
        if (element.type === 'code') {
          return (
            <UltraModernCodeBlock
              key={element.id}
              ...
              showLineNumbers={showLineNumbers[element.id] ?? true}
            />
          );
        } else {
          return (
...
// Ultra Modern Table of Contents with Advanced Features
const UltraModernTableOfContents = ({ content, isVisible, isDarkMode }) => {
  ...
  return (
    <motion.aside
      ...
      className={`fixed right-8 top-32 w-64 max-h-[calc(100vh-200px)] overflow-y-auto z-30 ${
...
// Ultra Modern Blog Detail Page Component
const UltraModernBlogDetailPage = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <motion.button
            ...
            className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl transition-all duration-300 font-semibold"
          >
            Back to Blog
          </motion.button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 overflow-x-hidden w-full">
      ...
      {/* Reading Progress Bar - Reduced Shadow */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 z-50 origin-left"
        style={{ scaleX: readingProgress / 100 }}
        initial={{ scaleX: 0 }}
      />

      {/* Floating Action Buttons - Reduced Shadow */}
        ...
        <AnimatePresence>
          {showScrollTop && (
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={scrollToTop}
              className="p-3 sm:p-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full transition-all"
            >
      ...
      {/* Table of Contents */}
      <UltraModernTableOfContents 
        content={post.content} 
        isVisible={showToc && !isFullWidth} 
        isDarkMode={isDarkMode}
      />
        ...
        <div className={`mx-auto px-4 sm:px-6 transition-all duration-300 w-full ${
          ...
          >
            ...
            >
              ...
              <span
                className="px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-bold text-white rounded-full"
                style={{
              ...
              {post.featured && (
                <motion.span
                  ...
                  className="px-3 sm:px-4 py-1 sm:py-1.5 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-xs sm:text-sm font-bold rounded-full flex items-center gap-1.5 sm:gap-2"
                >
            ...
            >
              ...
              >
                ...
                <div
                  id="share-menu"
                  className="hidden absolute top-full mt-2 right-0 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 z-10 min-w-[200px]"
                >
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base bg-gradient-to-r from-purple-600 to-pink-600 text-white transition-all"
              >
                <Code className="w-4 sm:w-5 h-4 sm:h-5" />
                <span>{showCodeOptions ? 'Hide' : 'Show'} Code Options</span>
              </motion.button>
            ...
            {post.featuredImage && (
              <motion.div
                ...
                className="relative rounded-2xl sm:rounded-3xl overflow-hidden mb-8 sm:mb-12 group w-full"
              >
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {post.tags.map((tag, index) => (
                  <motion.span
                    ...
                    className="px-3 sm:px-5 py-1.5 sm:py-2.5 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 text-gray-700 dark:text-gray-300 rounded-full text-xs sm:text-sm font-semibold cursor-pointer border border-gray-200 dark:border-gray-600 transition-all"
                  >
                    #{tag}
                  </motion.span>
                ))}
...
export default UltraModernBlogDetailPage;